...
module.exports.run = async function ({ api, event, args }) {
 ...
 sendMessage(`বস মাহিমের পক্ষ থেকে তোমাকে জন্মদিনের শুভেচ্ছা, @${name}!\n🎉HAPPY BIRTHDAY🎉`);
 const messages = [
 { delay: 3000, msg: `আরো একটি বছর তুমি কাটিয়ে দিলে। সুস্থ থাকো, ভালো থাকো এই কামনাই করি বার বার!\n🥰শুভ জন্মদিন🥰 @${name}` },
